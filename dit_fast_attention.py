...
def transform_model_fast_attention(raw_pipe, n_steps, n_calib, threshold=0.98, window_size=[-64,64],use_cache=False,seed=3):
    pipe = set_stepi_warpper(raw_pipe)
    
    cache_file=f"cache/{raw_pipe.config._name_or_path}_{n_steps}_{n_calib}.pt"
